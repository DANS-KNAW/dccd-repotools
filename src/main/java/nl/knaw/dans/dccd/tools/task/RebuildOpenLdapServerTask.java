...
import nl.knaw.dans.common.ldap.management.OpenLdapServerBuilder;
...
public class RebuildOpenLdapServerTask extends AbstractTask
{
	...
	public void run() throws FatalTaskException
	{
		...
		try
		{
			OpenLdapServerBuilder serverBuilder = new OpenLdapServerBuilder(LDAP_URL, LDAP_PRINCIPAL, LDAP_CREDENTIALS);
