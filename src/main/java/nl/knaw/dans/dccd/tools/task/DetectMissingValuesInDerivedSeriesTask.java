...
import nl.knaw.dans.dccd.tools.project.MissingValuesInDerivedSeriesDetector;
import nl.knaw.dans.dccd.tools.project.ProjectProcessor;
import nl.knaw.dans.dccd.tools.repo.AbstractProjectProcessingTask;

public class DetectMissingValuesInDerivedSeriesTask extends AbstractProjectProcessingTask
{
	public DetectMissingValuesInDerivedSeriesTask(String... idFilenames)
	{
		super(idFilenames);
	}
	...
	{
		return new MissingValuesInDerivedSeriesDetector(user, this);
	}
