...
import nl.knaw.dans.dccd.tools.project.MissingOriginalValueFilesDetector;
import nl.knaw.dans.dccd.tools.project.ProjectProcessor;
import nl.knaw.dans.dccd.tools.repo.AbstractProjectProcessingTask;

public class DetectMissingOriginalValueFilesTask extends AbstractProjectProcessingTask
{
	public DetectMissingOriginalValueFilesTask(String... idFilenames)
	{
		super(idFilenames);
	}
	...
	{
		return new MissingOriginalValueFilesDetector(user, this);
	}
