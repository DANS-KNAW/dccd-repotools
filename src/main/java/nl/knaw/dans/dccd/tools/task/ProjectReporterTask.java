...
import nl.knaw.dans.dccd.tools.project.ProjectReporter;
import nl.knaw.dans.dccd.tools.repo.AbstractProjectProcessingTask;

public class ProjectReporterTask extends AbstractProjectProcessingTask
{
	public ProjectReporterTask(String... idFilenames)
	{
		super(idFilenames);
	}
	...
	public ProjectProcessor createProcessor(DccdUser user) throws NoSearchEngineListeningException
	{
		...
		return new ProjectReporter(user, this);
	}
